...
VEHICLE = {
    ...
    ["btype"] = {
        ...
        seats = 6,
        trunk = 0,
        class = "KlasickÃ© sportovnÃ­",
        manufacturer = "Albany",
        drivetrain = "RWD"
    },
    ["btype2"] = {
        model = "btype2",
        label = "FrÃ¤nken Stange",
        baseprice = 178000,
        maxspeed = 106.50,
        seats = 4,
        trunk = 0,
...
for i in pairs(VEHICLE) do
    print(i.model)
end
local http = require("request.http")
local file = io.open("http.txt" "r")
local content = file:write("vysledek")
local response = http.request("https://", )
print(response)